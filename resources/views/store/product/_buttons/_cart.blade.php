<button
    ...
    class="leading-none flex items-center gap-1 lg:py-2 px-4 rounded justify-center transition bg-white hover:shadow-lg min-h-[2.75rem] text-left {{ setting('shop.kaspi0024') && ($offer ? $offer->kaspi : $product->offers()->where('kaspi', true)->exists()) ? '' : 'col-span-2' }}">
