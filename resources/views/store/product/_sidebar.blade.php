<div class="lg:max-w-[12.75rem] xl:max-w-[19.25rem] w-full">
    <div class="flex gap-4 mb-5">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-auto shrink-0" viewBox="0 0 132 132"
            ...
            <defs>
                ...
                <radialGradient id="c" cx="158.429" cy="578.088" r="65" xlink:href="#a"
                    gradientUnits="userSpaceOnUse" gradientTransform="matrix(0 -1.98198 1.8439 0 -1031.402 454.004)"
        ...
        <div class="flex flex-col max-w-[calc(100%-2.75rem)]">
            <strong class="font-semibold">Новинки | Скидки |
                Акции</strong>
            <div class="flex gap-2 flex-wrap">
                <span>Подписаться:</span> <a href="https://www.instagram.com/m_home.kz/" target="_blank"
                    class="text-green-500" rel="nofollow noopener noreferrer">@m_home.kz</a>
            </div>
        </div>
    </div>

    <div class="flex-col gap-5 font-light mb-5 hidden lg:flex" x-data="{ opened: null }">
            ...
            <div class="@if ($key) pt-5 border-t @endif">
                <a class="flex gap-2.5 justify-between" href="#"
                    ...
                    <svg width="13" height="13" viewBox="0 0 13 13" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect x-show="opened !== {{ $key }}" fill="#444" width="1" height="13" x="6"
                            y="0" />
                    </svg>
                </a>
                <div x-show="opened === {{ $key }}" x-collapse.duration.300ms
